...
`docker-compose exec php-fpm chown -R www-data:www-data /app1/public`
...
```
  ...
  ### Bootable Docker
  sudo ln -s /home/deploy/patientv2/docker_lemp/docker/docker_boot.service  /etc/systemd/system/docker_boot.service
